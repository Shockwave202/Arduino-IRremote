...
bool motor1_acceleration;
bool motor1_deceleration;
bool motor2_acceleration;
bool motor2_deceleration;
int motor1_speed;
int motor2_speed;
...
void setup()
{
  ...
  if (checkingByte1 != 0xaa || checkingByte2 != 0xaa)
  {
    ...
    motor1_forward_speed = 200;
    motor1_backward_speed = 200;
    motor2_forward_speed = 200;
    motor2_backward_speed = 200;
